...
**Strong evidence:** `go test ./...` (`wsl bash -i -c "cd /mnt/c/Users/vishn/desktop/chaathan && go test ./..."` on Windows), `go vet ./...`, successful build, direct inspection of affected flow and all downstream readers.
